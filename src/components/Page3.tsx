          ...
          <div className="bg-purple-900/80 backdrop-blur-sm border-2 border-purple-500 text-white p-8 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-3xl font-bold text-purple-300 mb-4">$19.99<span className="text-sm">/mo</span></p>
              ...
              >
                ...
                <p className="text-3xl font-bold text-purple-300 mb-4">$39.99<span className="text-sm">/mo</span></p>
                <ul className="space-y-2 text-sm mb-6">
                  <li>✓ 4K Export</li>
                  <li>✓ 300 AI Tools</li>
              ...
              >
                ...
                <p className="text-3xl font-bold text-purple-300 mb-4">$79.99<span className="text-sm">/mo</span></p>
                <ul className="space-y-2 text-sm mb-6">
                  <li>✓ 8K Export</li>
